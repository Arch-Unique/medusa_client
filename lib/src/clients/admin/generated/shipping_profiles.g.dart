...
class _ShippingProfilesResource implements ShippingProfilesResource {
  ...
  Future<AdminShippingProfilesListRes> list(
    ...
    final _options = _setStreamType<AdminShippingProfilesListRes>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    late AdminShippingProfilesListRes _value;
    try {
      _value = AdminShippingProfilesListRes.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<AdminShippingProfilesRes> create(
    ...
    final _options = _setStreamType<AdminShippingProfilesRes>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late AdminShippingProfilesRes _value;
    try {
      _value = AdminShippingProfilesRes.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<AdminDeleteShippingProfileRes> delete(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<AdminDeleteShippingProfileRes>(Options(
      method: 'DELETE',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late AdminDeleteShippingProfileRes _value;
    try {
      _value = AdminDeleteShippingProfileRes.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
