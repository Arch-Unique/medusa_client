...
class _InventoryItemsResource implements InventoryItemsResource {
  ...
  Future<List<AdminGetInventoryItemsParams>> list({
    ...
    final _options = _setStreamType<List<AdminGetInventoryItemsParams>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    late List<AdminGetInventoryItemsParams> _value;
    try {
      _value = _result.data!
          .map((dynamic i) =>
  ...
  Future<AdminInventoryItemsListWithVariantsAndLocationLevelsRes> create(
    ...
    late AdminInventoryItemsListWithVariantsAndLocationLevelsRes _value;
    try {
      _value = AdminInventoryItemsListWithVariantsAndLocationLevelsRes.fromJson(
          _result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
  ...
  Future<AdminInventoryItemsRes> retrieve(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<AdminInventoryItemsRes>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<AdminInventoryItemsDeleteRes> delete(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<AdminInventoryItemsDeleteRes>(Options(
      method: 'DELETE',
      headers: _headers,
      extra: _extra,
    )
