...
class _CustomersResource implements CustomersResource {
  ...
  Future<AdminCustomersListRes> list({
    ...
    final _options = _setStreamType<AdminCustomersListRes>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<AdminCustomersRes> create(
    ...
    final _options = _setStreamType<AdminCustomersRes>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late AdminCustomersRes _value;
    try {
      _value = AdminCustomersRes.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
