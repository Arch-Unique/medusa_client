...
class _StoresResource implements StoresResource {
  ...
  Future<AdminExtendedStoresRes> retrieve(
    ...
    final _options = _setStreamType<AdminExtendedStoresRes>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<AdminStoresRes> update(
    ...
    final _options = _setStreamType<AdminStoresRes>(Options(
      method: 'PUT',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<AdminStoresRes> deleteCurrency(
    ...
    final _options = _setStreamType<AdminStoresRes>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          '/admin/store/currencies/${currencyCode}',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
